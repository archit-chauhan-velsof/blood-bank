...
// const registerDonor_Schema = Yup.object({
          ...
          <div className="card">
            <div className="card-body">
              <Formik
                ...
                validationSchema={registerDonor_Schema}
                              ...
                              <div>
                                <div className="form-check form-check-inline">
                                  <Field
                                    ...
                                    id="donated_previously_1"
                                    value="Yes"
                                  />

                                  <label
                                    className="form-check-label"
                                    htmlFor="donated_previously_1"
                                  >
                                    Yes
                                  </label>
                                </div>
                                <div className="form-check form-check-inline">
                                  <Field
                                    ...
                                    type="radio"
                                    name="donated_previously"
                                    id="donated_previously_2"
                                    value="No"
                                  />
                                  <label
                                    className="form-check-label"
                                    htmlFor="donated_previously_2"
                                  >
                                    No
                                  </label>
                                </div>
                          ...
                          <div className="col-12">
                            <div className="form-check">
                              ...
                              <label
                                ...
                                htmlFor="agree"
                              >
                                I agree to be contacted by blood banks, SBTCs
                                and NBTC
                              </label>
                              <ErrorMessage
                                name="agree"
